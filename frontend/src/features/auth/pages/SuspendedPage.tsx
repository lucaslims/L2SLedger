    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sua conta foi temporariamente suspensa</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-lg border bg-muted/50 p-4 text-sm text-muted-foreground">
            <p className="font-semibold text-foreground">O que isso significa?</p>
            <p className="mt-2">
              Sua conta foi suspensa devido a uma violação dos termos de uso ou por motivos de
              segurança.
            </p>
            <p className="mt-2">
              Entre em contato com nossa equipe de suporte para mais informações sobre como reativar
              sua conta.
            </p>
          </div>

          <div className="rounded-lg border-l-4 border-orange-500 bg-orange-50 p-4 text-sm dark:bg-orange-950/30">
            <p className="font-semibold text-orange-800 dark:text-orange-300">Precisa de ajuda?</p>
